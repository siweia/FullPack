...
L["STRING_OPTIONS_MICRODISPLAYS_WARNING"] = "|cFFFFFF00注意:|r 無法顯示微型顯示內容，因為它對齊到最下方，而狀態列已被停用。"
L["STRING_OPTIONS_MICRODISPLAYSSIDE"] = "上方微型顯示內容"
L["STRING_OPTIONS_MICRODISPLAYSSIDE_DESC"] = "將微型顯示內容放在視窗的最上方或最下方。"
...
L["STRING_OPTIONS_REPORT_HEALLINKS_DESC"] = [=[發送報告並啟用此選項時，|cFF55FF55助益|r法術是會傳送法術連結而不是名稱。
|cFFFF5555傷害|r法術則預設會用法術連結來報告。]=]
...
L["STRING_OPTIONS_SHOW_STATUSBAR_DESC"] = "顯示或隱藏最下方的狀態列。"
...
L["STRING_OPTIONS_STRETCH"] = "拉伸按鈕在最上方"
L["STRING_OPTIONS_STRETCH_DESC"] = "將拉伸按鈕放在視窗的最上方。"
L["STRING_OPTIONS_STRETCHTOP"] = "拉伸按鈕永遠在最上方"
...
L["STRING_OPTIONS_TEXT_FIXEDCOLOR_DESC"] = [=[同時更改左右文字的顏色。

如果已啟用|cFFFFFFFF職業顏色|r則會忽略。]=]
L["STRING_OPTIONS_TEXT_FONT"] = "字體"
L["STRING_OPTIONS_TEXT_FONT_DESC"] = "同時更改左右文字的字體。"
...
L["STRING_OPTIONS_TEXT_SIZE_DESC"] = "同時更改左右文字的大小。"
...
L["STRING_OPTIONS_TOOLBAR_SETTINGS_DESC"] = "這些選項會更改視窗最上方的主要選單。"
L["STRING_OPTIONS_TOOLBARSIDE"] = "標題列在上方"
L["STRING_OPTIONS_TOOLBARSIDE_DESC"] = [=[將標題列放置在視窗的最上方。
...
L["STRING_OPTIONS_TOOLTIPS_ANCHOR_ATTACH"] = "滑鼠提示位置"
...
L["STRING_OPTIONS_TOOLTIPS_ANCHOR_RELATIVE"] = "對齊位置"
L["STRING_OPTIONS_TOOLTIPS_ANCHOR_RELATIVE_DESC"] = "滑鼠提示要放在對齊位置的哪一側。"
