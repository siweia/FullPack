...
L["STRING_OPTIONS_TEXT_LTRANSLIT"] = "Транслитерация"
L["STRING_OPTIONS_TEXT_LTRANSLIT_DESC"] = "Представить русские буквы, которые никто не понимает, в виде латиницы  (транслитерировать)"
