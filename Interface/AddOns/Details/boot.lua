...
--> global name declaration
		...
		_detalhes.build_counter = 7336
		_detalhes.alpha_build_counter = 7336 --if this is higher than the regular counter, use it instead
