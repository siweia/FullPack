...
--> global name declaration
		...
		_detalhes.build_counter = 7246
		_detalhes.alpha_build_counter = 7246 --if this is higher than the regular counter, use it instead
...
--[[
|cFFFFFF00v8.2.5.7239.140 (|cFFFFCC00January 06th, 2020|r|cFFFFFF00)|r:\n\n
