...
--> global name declaration
		...
		_detalhes.build_counter = 7303
		_detalhes.alpha_build_counter = 7303 --if this is higher than the regular counter, use it instead
