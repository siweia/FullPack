...
L["Click the fullscreen button for a maximized view of MDT."] = "Вы можете перевести MDT в полноэкраный режим, нажав стрелочку в правом верхнем углу."
...
L["Right-Click to reset NPC position"] = "Щелкните ПКМ, чтобы сбросить положение НИП"
...
L["Shift-Click to delete all presets for this dungeon"] = "Shift+ЛКМ, чтобы удалить все маршруты для этого подземелья"
