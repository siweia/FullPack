...
T.KnownSpells = {
	...
	[54]={
		...
		{type="nuke", target="mark", damageATK=90}
	},
	...
	[91]={type="aura", target=1, duration=3, plusDamageDealtA=-0.6, desc="Reduces the damage dealt by the furthest enemy by 1 for 3 rounds."},
