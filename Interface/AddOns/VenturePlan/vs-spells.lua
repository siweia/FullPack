...
T.KnownSpells = {
	...
	[96]={type="aura", target=1, duration=2, damageATK1=40, modDamageDealt=-20},
	...
	[91]={type="aura", target=1, duration=3, plusDamageDealtA=-0.6},
	...
	[95]={
		...
		{type="nuke", target="enemy-back", damageATK=30},
	},
	[198]={type="aura", target=4, duration=2, thornsATK=50, plusDamageTakenA=-0.5},
	[302]={type="aura", target="all-enemies", duration=1, modDamageDealt=-20, damageATK1=20},
	[229]={type="aura", target="random-ally", duration=1e3, modDamageTaken=-50},
