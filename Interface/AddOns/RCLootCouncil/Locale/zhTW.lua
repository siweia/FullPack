...
- award - 分配包裡已拾取的物品
- winners - 顯示贏得分配的玩家]=]
L["chat_commands_add"] = "- add [item]- 將一個物品加入分配"
L["chat_commands_award"] = "- award     - 開始分配你之前稍后分配的物品。"
L["chat_commands_config"] = "- config    - 打開設置界面"
L["chat_commands_council"] = "- council   - 打開議會界面"
L["chat_commands_history"] = "- history   - 打開歷史界面(簡稱： 'h' 或者 'his')"
L["chat_commands_open"] = "- open      - 打開投票界面"
L["chat_commands_reset"] = "- reset     - 重置界面位置"
L["chat_commands_sync"] = "- sync      - 打開設置同步器"
L["chat_commands_test"] = "- test (#)  - 模擬有#個物品的分配進程。如果省略默認為一個物品"
L["chat_commands_version"] = "- version   - 打開版本檢查器 (簡稱： 'v' 或者 'ver')"
L["chat_commands_whisper"] = "- whisper   - 顯示密語幫助"
L["chat_commands_winners"] = "- winners   - 顯示稍后分配的物品的獲勝者。"
