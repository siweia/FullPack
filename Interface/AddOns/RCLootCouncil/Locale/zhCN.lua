...
L[" you are now the Master Looter and RCLootCouncil is now handling looting."] = " 你现在是战利品分配者，RCLootCouncil 正在管理分配。"
L["&p was awarded with &i for &r!"] = "&p 获得了 &i 理由为 &r！"
L["2 Piece"] = "两件"
L["2nd Tier Piece"] = "两件套装"
L["4 Piece"] = "3 件"
L["4th Tier Piece"] = "4 件套装"
...
L["A tab delimited output for Excel. Might work with other spreadsheets."] = "Tab（字符）分隔的导出格式以支持 Excel。也有可能支持在其他类型表格软件（例如 Numbers）"
L["A tab delimited output for Excel. Might work with outher spreadsheets."] = "Tab（字符）分隔的导出格式以支持 Excel。也有可能支持在其他类型表格软件（例如 Numbers）"
L["Abort"] = "中止"
...
L["Banking"] = "收藏"
L["BBCode export, tailored for SMF."] = "BBCode 格式导出，为 SMF (什么东西？) 支持。"
L["Border"] = "边框"
L["Border Color"] = "边框颜色"
L["Button"] = "按钮"
...
L["leaderUsage_desc"] = "当做为团长的时候，采用相同的配置"
L["Length"] = "长度"
L["Log"] = "记录"
...
L["Only use in raids"] = "只在团本中启用"
L["onlyUseInRaids_desc"] = "选中此项，将自动在 5 人副本中禁用 RCLootCouncil。"
L["open"] = "开启"
...
L["You cannot start an empty session."] = "你无法启动空白的分装程序"
