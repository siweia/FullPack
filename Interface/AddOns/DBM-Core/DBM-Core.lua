...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20241113031003")
...
DBM.DisplayVersion = "11.0.27"--Core version
DBM.classicSubVersion = 0
DBM.ReleaseRevision = releaseDate(2024, 11, 12) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
...
---@param revision number|string Either a number in the format "202101010000" (year, month, day, hour, minute) or string "20241113031003" to be auto set by packager
