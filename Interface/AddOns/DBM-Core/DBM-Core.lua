...
-------------------------------
DBM = {
	Revision = tonumber(("$Revision: 16302 $"):sub(12, -3)),
	DisplayVersion = "7.2.9", -- the string that is shown as version
	ReleaseRevision = 16302 -- the revision of the latest stable version that is available
}
