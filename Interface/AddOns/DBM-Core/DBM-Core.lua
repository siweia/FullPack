...
DBM = {
	Revision = parseCurseDate("20190821024804"),
	DisplayVersion = "8.2.14", -- the string that is shown as version
	ReleaseRevision = releaseDate(2019, 8, 20) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
