...
L["Config - Appearance - Waypoint - Footer - SubtextAlpha"] = "Subtext Opacity"
...
L["Config - ExtraFeature - TomTomSupport - Enable"] = "追蹤TomTom的路徑點"
L["Config - ExtraFeature - TomTomSupport - Enable - Description"] = "啟用Waypoint UI對TomTom路徑點追蹤的支援。你可以透由在世界地圖右鍵點擊任何TomTom的路徑點來追蹤TomTom路徑點， 並從內容選單中選擇“設置為路徑點箭頭”。"
L["Config - ExtraFeature - TomTomSupport - AutoReplaceWaypoint"] = "自動替換路徑點"
L["Config - ExtraFeature - TomTomSupport - AutoReplaceWaypoint - Description"] = "自動使用Waypoint介面來追蹤TomTom的路徑點。"
L["Config - ExtraFeature - DugisSupport"] = "Dugi Questing Essential"
L["Config - ExtraFeature - DugisSupport - Enable"] = "追蹤Dugi的路徑點"
L["Config - ExtraFeature - DugisSupport - Enable - Description"] = "自動使用Waypoint介面來追蹤Dugi Questing Essential的路徑點。"
L["Config - ExtraFeature - DugisSupport - AutoReplaceWaypoint"] = "自動替換路徑點"
L["Config - ExtraFeature - DugisSupport - AutoReplaceWaypoint - Description"] = "自動追蹤當前Dugi的路徑點。"
L["Config - ExtraFeature - SilverDragonSupport"] = "SilverDragon"
L["Config - ExtraFeature - SilverDragonSupport - Enable"] = "啟用Silver Dragon的路徑點"
L["Config - ExtraFeature - SilverDragonSupport - Enable - Description"] = "這需要啟用SilverDragon內建的路徑點選項。"
...
L["DugisGuideViewerZ - ReplacePrompt"] = "你想要替換你當前的路徑點為Dugi的路徑點\"%s\"嗎？"
L["DugisGuideViewerZ - ReplacePrompt - Yes"] = "替換"
