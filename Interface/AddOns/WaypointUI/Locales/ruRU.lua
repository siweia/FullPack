...
L["Config - ExtraFeature - SilverDragonSupport"] = "Поддержка SilverDragon"
L["Config - ExtraFeature - SilverDragonSupport - Enable"] = "Улучшить путевой точки Silver Dragon"
L["Config - ExtraFeature - SilverDragonSupport - Enable - Description"] = "Для этого необходимо включить встроенную в SilverDragon опцию установки путевых точек."
...
L["DugisGuideViewerZ - ReplacePrompt"] = "Хотите ли вы заменить текущую путевую точку на путевую точку Dugi \"%s\"?"
L["DugisGuideViewerZ - ReplacePrompt - Yes"] = "Замена"
L["DugisGuideViewerZ - ReplacePrompt - No"] = "Отмена"
