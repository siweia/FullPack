...
L["DepositTradeGoodsTip"] = "|nЛКМ чтобы внести предметы отряда, ПКМ чтобы сменить режим внесения.|nЕсли отображается граница кнопки, реагенты из ваших сумок также будут вноситься в ваш банк отряда."
