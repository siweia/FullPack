...
L["Name Offset"] = "Y-отступ имени"
L["Health Offset"] = "Y-отступ хп"
...
L["iLvlToShowTip"] = "|nРаботает только с фильтром илвл. Разделяет вещи по итлв." 
...
L["BlockRequest"] = "Блок инвайтов от незнакомцев"
L["BlockRequestTip"] = "|nЕсли выбрано, предлагает приглашения только от друзей и согильдийцев."
...
L["Map Scale"] = "Масштаб карты в окне"
L["Maximize Map Scale"] = "Масштаб карты"
...
L["BagSearchTip"] = "|nКлик для поиска по сумкам.|nМожно вводить имена или локации получения.|n'boe' для BOE вещей , 'aoe' для вещей отряда и 'quest'для квестовых.|nUse expasion ID to find items from specific expansion.|n|nНажми ESC чтобы очистить ввод." -- need translation
...
L["ToggleActionbarTip"] = "|nОпция переключения панели заклинаний, не требует перезагурзки UI."
L["IgnoreNoteHelp"] = "Вы можете добавить заметку в игнор двойным щелчком мыши."
L["RaidTargetX"] = "X-отспут цели рейда"
L["RaidTargetY"] = "Y-отспут цели рейда"
L["GlowMode"] = "Режим подсветки кнопок" 
L["Spacing"] = "Интервал"
L["AddPower"] = "Доп. ресурс"
L["AddPowerTip"] = "|nПоказывать дополнительный ресурс для классов ШП и Ферал" 
L["AuraWatch MinCD"] = "Минимальный КДЭ"
L["MinCDTip"] = "|nВремя восстановления заклинания отображается только тогда, когда его время восстановления больше второго значения."
L["HideInCombat"] = "Скрыть в бою" 
L["HideInCombatTip"] = "|nВыберите как будут скрываться подсказки в бою.|nПодсказки видны только когда вы удерживаете выбранную кнопку."
L["HideDPSRole"] = "Скрыть роль ДПС"
L["ShowRoleMode"] = "SПоказать роли"
L["PlateRange"] = "Дистанция панелией имён" 
L["MoreFontSize"] = "Больше размеров шрифта"
L["EditFont"] = "Шрифт окна редактирования"
L["IgnoredRares"] = "Чёрный список рарников"
L["IgnoredRaresTip"] = "|nВведите ID рарника, чтобы не получать уведомления о нём, используйте пробел для нескольких ID."
L["QuestTracker"] = "Тема для QuestTracker"
L["PurchaseTabTip"] = "Вам необходимо отключить аддон и использовать стандартный Банк для покупки дополнительных вкладок."
L["AccountBank Width"] = "Ширина банка отряда"
L["ShowGlow"] = "Свечение активного заклинания"
L["KeyDown"] = "Каст при нажатии"
L["ButtonLock"] = "Заблокировать панели"
L["KeyDownTip"] = OPTION_TOOLTIP_ACTION_BUTTON_USE_KEY_DOWN
L["ButtonLockTip"] = OPTION_TOOLTIP_LOCK_ACTIONBAR
L["LowerItem"] = "Мин ИЛВЛ"
L["FilterLower"] = "Фильтр ИЛВЛ"
L["ShowHealthAbsorb"] = "Текущее+погл."
L["LeaderOnly"] = "Только от РЛ" 
L["LeaderOnlyTip"] = "|nЕсли включено, уведомления отправляются только рл или ра."
L["SingingSocket"] = "Enhanced gem sockets" -- need translation
L["SingingSocketTip"] = "|nIf enabled, add a quick gem selection tool onto Siren ring and Reshii wraps." -- need translation
...
L["BankDepositTip"] = "|nDuoble click the left button to deposit reagents." -- need translation
L["AccountDepositTip"] = "|nDuoble click the left button to deposit warband items, right click to swith deposit mode.|nIf the button border shown, the reagents from your bags would deposit into your warband bank as well." -- need translation
L["LegacyItem"] = "Legacy items" -- need translation
...
L["AttachedError"] = "Window2 and window3 cannot attached to each other." -- need translation
L["AttachedTo"] = "Attached Target" -- need translation
L["AttachedToTip"] = "Select the target window for attachment." -- need translation
L["AttachedPoint"] = "Attached Anchor" -- need translation
L["AttachedPointTip"] = "Select the attached anchor to target window." -- need translation
