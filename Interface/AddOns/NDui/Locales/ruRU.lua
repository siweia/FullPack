...
L["BagSearchTip"] = "|nКлик для поиска по сумкам.|nМожно вводить имена или локации получения.|n'boe' для BOE вещей , 'aoe' для вещей отряда и 'quest'для квестовых.|n|nНажми ESC чтобы очистить ввод."
...
L["OverAbsorb"] = "Поверх панели поглощения"
L["OverAbsorbTip"] = "|nЕсли включено, показывать поверх полосы поглощения, если значение поглощения больше максимального здоровья.|n|nЭта опция управляет всеми рамками."
