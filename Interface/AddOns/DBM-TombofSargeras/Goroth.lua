...
mod:SetRevision(("$Revision: 16336 $"):sub(12, -3))
...
local timerCrashingCometCD				= mod:NewCDTimer(18.3, 232249, nil, nil, nil, 3)
local timerInfernalSpikeCD				= mod:NewCDTimer(16.7, 233055, nil, nil, nil, 3)
